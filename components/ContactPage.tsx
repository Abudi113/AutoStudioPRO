...
import { Check, Mail, Phone, MapPin, ShieldCheck, Rocket, Zap, Crosshair } from 'lucide-react';
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                        ...
                        >
                            ...
                            <form className="space-y-5">
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xl rounded-2xl shadow-xl shadow-blue-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                                >
                                    {t('contactFormButton')}
                                </button>
                            </form>
